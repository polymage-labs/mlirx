...
// To minimize conflicts with upstream, we will just restrict this test case
// store to load forwarding only and not the replacement of invariant accesses.
// We'll have a separate test for the latter.
