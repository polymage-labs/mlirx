...
/// Replaces all affine for ops that can be parallelized with 1-D affine
/// ParallelOp. mlir::isLoopParallel give the affine forOps which can be
/// parallelized. No cost model for it to drive this parallelization at the
/// moment.
