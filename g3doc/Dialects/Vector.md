...
| :-------: | :-------: | ----------- |
| `mask_dim_sizes` | `ArrayAttr` | 64-bit integer array attribute attribute |

#### Results:

1. &laquo;unnamed&raquo;: vector of 1-bit integer values
...
1. `rhs`: vector of any type values
1. `acc`: vector of any type values
1. `masks`: vector of 1-bit integer values

#### Attributes:

| Attribute | MLIR Type | Description |
| :-------: | :-------: | ----------- |
| `indexing_maps` | `ArrayAttr` | AffineMap array attribute attribute |
| `iterator_types` | `ArrayAttr` | array attribute attribute |

#### Results:

1. &laquo;unnamed&raquo;: vector of any type values
...
| Attribute | MLIR Type | Description |
| :-------: | :-------: | ----------- |
| `position` | `ArrayAttr` | 32-bit integer array attribute attribute |
...
1. `source`: any type
1. `dest`: vector of any type values
...
| Attribute | MLIR Type | Description |
| :-------: | :-------: | ----------- |
| `offsets` | `ArrayAttr` | 64-bit integer array attribute attribute |
...
| :-------: | :-------: | ----------- |
| `offsets` | `ArrayAttr` | 64-bit integer array attribute attribute |
| `sizes` | `ArrayAttr` | 64-bit integer array attribute attribute |
| `strides` | `ArrayAttr` | 64-bit integer array attribute attribute |
...
| Attribute | MLIR Type | Description |
| :-------: | :-------: | ----------- |
| `permutation_map` | `AffineMapAttr` | AffineMap attribute attribute |
